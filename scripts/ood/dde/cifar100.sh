...
in_score=sum
group_num=200
group_size=100 ## activate only when group_num=-1
ood_number=10000
...
do
    for hat_M in 10 #  2000 5000 10000 20000 50000 100000 200000 250000   ## beta=500时候 ood效果很好. 
    do
