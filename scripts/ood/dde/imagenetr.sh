...
do
    for hat_M in 50 #  2000 5000 10000 20000 50000 100000 200000 250000   ## activated-aware scores, 0 means activation-agnostics  ptis tisp  ###part_of_speech_tagging, neglabel_wordnet  fixedclip_negoodprompt_fullcorpus
    do
        CUDA_VISIBLE_DEVICES=4 python main.py \
        --config configs/datasets/imagenet/imagenet_cross_domain_imagenetr.yml \
